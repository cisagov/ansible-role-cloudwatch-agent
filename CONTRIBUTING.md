...
issue](https://github.com/cisagov/ansible-role-cloudwatch-agent/issues) in
...
request](https://github.com/cisagov/ansible-role-cloudwatch-agent/pulls), you
...
```console
cd ansible-role-cloudwatch-agent
pyenv virtualenv <python_version_to_use> ansible-role-cloudwatch-agent
pyenv local ansible-role-cloudwatch-agent
